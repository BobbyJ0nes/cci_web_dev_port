# week 4 · portfolio shell — grid + flex + responsive
...
pieces are known, so the layout follows the work instead of forcing it.
the shell has one job: _introduce the reader, then step out of the way_.
...
## build log
- **v0** — wireframe on paper: header / intro / work grid / weekly list /
  footer.
...
- **v5** — wrote this documentation.

## screenshots
> _to add before submission:_
> - `screens/portfolio-mobile.png` (320px)
> - `screens/portfolio-tablet.png` (800px)
> - `screens/portfolio-desktop.png` (1280px)
> - `screens/portfolio-dark.png` (same viewport, dark theme)
